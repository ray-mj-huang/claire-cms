...
import { saveProduct, uploadProductImage } from '../../../features/products/productsSlice'
...
const NewProduct = (): React.ReactElement => {
  ...
  const { status = 'idle', uploadingImage = false } = useSelector((state: RootState) => state.products || {})
  ...
  if (status === 'loading' && !uploadingImage) {
    return <Loading />
  }
